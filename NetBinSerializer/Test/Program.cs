...
namespace Test
{
    ...
    class Program
    {
        ...
        static void TestLowLevelSerialization()
        {
            ...
            sstream.WriteCollection<List<int>, int>(writeList);
        ...
        static void TestHighLevelSerialization()
        {
            ...
            HighSerializeStream sstream = serializer.GetStream();
            //Write simple values
            ...
            HighSerializeStream dstream = serializer.GetStream(sstream.GetBytes());
            //Read simple values
